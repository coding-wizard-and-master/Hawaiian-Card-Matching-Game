...
function appendNewCard(parentElement) {
  ...
  let card = parentElement.appendChild(document.createElement("div"));
  ...
  let attr = card.appendChild(document.createElement("div"));
  attr.classList.add("card-down");

  let attr2 = card.appendChild(document.createElement("div"));
  attr2.classList.add("card-up");
...
function shuffleCardImageClasses() {
  ...
  let cards = ["image-1", "image-1", "image-2", "image-2", "image-3", "image-3", "image-4", "image-4", "image-5", "image-5", "image-6", "image-6"];
...
let winAudio = new Audio('audio/win2.wav')
